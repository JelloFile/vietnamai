...
function s4c4_1(){
  aiMessage("Robert S. McNamara was a U.S. secretary who revamped operations in Vietnam. He was alive from 1916 to 2009.")
...
function s4c13_1(){
  aiMessage("The difference between what you say vs what you actually do. Like how you asked but did not care.")
...
function s4c14_1(){
  aiMessage("The highest-ranking public university located in Northern Ohio. Didn't you know that? ")
...
function s4c15_1(){
  aiMessage("An act stating that the president needs permission from the congress to deploy troops.")
